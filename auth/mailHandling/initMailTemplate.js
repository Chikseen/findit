  ...
  initmail() {
    ...
    <html lang="en">
      ...
      <body>
        ...
        <a href="${process.env.NODE_ENV == "develop" ? "http://localhost:8080" : "drunc.net"}">checkSite</a>
      </body>
    </html>`;
  },
  valimail(id) {
    ...
    <html lang="en">
      ...
      <body>
        ...
        <a href="${process.env.NODE_ENV == "develop" ? 'http://localhost:8080' : 'drunc.net'}/varifyer?verificationID=${id}">Validate me</a>
        <p>Your mailer dosent support HTML ??? try copy this link in the browsers searchbar</p>
        <p>${process.env.NODE_ENV == "develop" ? 'http://localhost:8080' : 'drunc.net'}/varifyer?verificationID=${id}</p>
        </body>
    </html>
    `;
  },
  projinvite() {
    ...
    <html lang="en">
      ...
      <body>
        ...
        <a href="${process.env.NODE_ENV == "develop" ? "http://localhost:8080" : "drunc.net"}/home">go To your account</a>
      </body>
    </html>
    `;
  },
